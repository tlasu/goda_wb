...
list_h0l0_0 = list(set([ 0.002, 0.003, 0.004, 0.005,
                0.01, 0.02, 0.025, 0.03, 0.035, 0.04, 
                0.05, 0.06, 0.07, 0.08, 0.09, 0.1] + target_h0l0))
list_h0l0_0.sort()
...
# %%
for h0l0 in list_h0l0_0:
    plt.plot(list_dl0 / h0l0, aks_dict[f"{h0l0}"], label=f"Goda's model $H'_o/L_o={h0l0}$")
plt.xlim(0,1)
